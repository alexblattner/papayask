...
const Search = () => {
    ...
    const [budget,setBudget] = useState<[string | number | readonly string[] | undefined,string | number | readonly string[] | undefined]>([0,""]);
    const [netWorth,setNetWorth] = useState<[string | number | readonly string[] | undefined,string | number | readonly string[] | undefined]>([0,""]);
    const [yearlyRevenue,setYearlyRevenue] = useState<[string | number | readonly string[] | undefined,string | number | readonly string[] | undefined]>([0,""]);
    const [experience,setExperience] = useState<[string | number | readonly string[] | undefined,string | number | readonly string[] | undefined]>([0,""]);
      ...
      <div>
        ...
        <div id="top">
            <div id="search">
                ...
                <div>
                    <span>Budget</span>
                    <input type="text" value={budget[0]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                    ...
                    <input type="text" value={budget[1]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                            setBudget([budget[0],""]);
                        }else{
                ...
                <div>{/*all */}
                    <span>Net Worth($)</span>
                    <input type="text" value={netWorth[0]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                    ...
                    <input type="text" value={netWorth[1]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                ...
                <div>{/*all */}
                    ...
                    <input type="text" value={yearlyRevenue[0]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                    ...
                    <input type="text" value={yearlyRevenue[1]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                            setYearlyRevenue([0,yearlyRevenue[1]]);
                        }else{
                ...
                <div>{/*all */}
                    ...
                    <input type="text" value={experience[0]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                    ...
                    <input type="text" value={experience[1]} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                        let value = (e.target as HTMLInputElement).value;
                        if(value==""){
                            setExperience([0,experience[1]]);
                        }else{
